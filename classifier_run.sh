...
export VOX_GRID_LEAF_X="0.03"
export VOX_GRID_LEAF_Y="0.03"
export VOX_GRID_LEAF_Z="0.03"
export MINIMUM_GREEN_POINTS="0.9"
export ROS_LOOP_RATE="1.5"
export HEIGHT_THRESHOLD="-0.20"
export POINT_CLOUD_TO_ROBOT_CENTER="0.9"
# export LASER_X="0.0"
# export LASER_Y="0.0"
# export LASER_Z="0.0"
...
export GENERATE_PATH_LINE_K="10"
export LASER_TYPE="simulated"
export ROBOT_BASE_X="0.65"  
